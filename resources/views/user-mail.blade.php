...
<body>
    <div class="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
        <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
            <h3 class="text-2xl">Thanks for signing up for {{config('MAIL_FROM_NAME')}}</h3>
            ...
            <div class="mt-4">
                <a class="px-2 py-2 text-blue-200 bg-blue-600 rounded">{{$details['body']}}</a>
                <p class="mt-4 text-sm">{{$details['title']}}
