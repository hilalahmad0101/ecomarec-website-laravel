        ...
        <div class="container mx-auto flex lg:space-x-4 space-x-0 md:p-3 p-0 pt-6">
            ...
            <div class="bg-white p-6 shadow w-full h-screen">
                ...
                <form action="" wire:submit.prevent='updateProfile'>
                    ...
                    <div class="grid md:grid-cols-3 grid-cols-1 gap-10 my-7">
                        <div class="relative z-0">
                            <input type="text" id="floating_standard" wire:model.lazy='first_name'
                                class="block py-2.5 px-0 w-full  text-sm text-gray-500 bg-transparent border-0 border-b border-blue-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-customeorange-600 focus:outline-none focus:ring-0 focus:border-customeorange-600 peer"
                                placeholder=" " />
                            <label for="floating_standard"
                                class="absolute text-sm customeorange-600 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-customeorange-600 peer-focus:dark:text-customeorange-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First
                                Name</label>
                            @error('first_name')
                    ...
                    <div class=" flex my-9">
                        <h5 class="text-customeorange-600 md:text-lg text-sm font-bold ">Your Gender</h5>
                        <div class="flex space-x-4  ml-3">
                            <div class="flex items-center">
                                <input checked id="default-radio-2" type="radio" wire:model.lazy='gender'
                                    ...
                                    class="w-4 h-4 text-customeorange-600 bg-gray-100 border-gray-300 focus:ring-customeorange-600 dark:focus:ring-customeorange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                <label for="default-radio-2"
                                    class="ml-2 text-sm font-medium text-customeorange-600 dark:text-gray-300">Male</label>
                            </div>
                            <div class="flex items-center">
                                <input checked id="default-radio-1" type="radio" wire:model.lazy='gender'
                                    value="{{ $gender }}" name="default-radio"
                                    class="w-4 h-4 text-customeorange-600 bg-blue-100 border-gray-300 focus:ring-customeorange-600 dark:focus:ring-customeorange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                <label for="default-radio-1"
                                    class="ml-2 text-sm font-medium text-customeorange-600 dark:text-gray-300">Female</label>
                            </div>
                        </div>
                        @error('gender')
                            <span class="text-red-500">{{ $message }}</span>
                        ...
                        <div class="relative z-0">
                            <div class="relative z-0">
                                <input type="email" id="floating_standard" wire:model.lazy='email'
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b border-blue-800 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-customeorange-600 focus:outline-none focus:ring-0 focus:border-customeorange-600 peer"
                                    placeholder=" " />
                                <label for="floating_standard"
                                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-customeorange-600 peer-focus:dark:text-customeorange-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your
                                    Email</label>
                                @error('email')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                    ...
                    <div class="my-9">
                        <div class="relative z-0 my-6">
                            <input type="text" id="floating_standard" wire:model.lazy='address'
                                ...
                                placeholder=" " />
                            <label for="floating_standard"
                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-customeorange-600 peer-focus:dark:text-customeorange-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Add
                                Address</label>
                            @error('address')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
