                                                    ...
                                                    <tr class="cart_item">
                                                        ...
                                                        <td class="product-total">
                                                            <span class="woocommerce-Price-amount amount"
                                                                data-price="{{ $cart->products->price * $cart->qty }}"
                                                                title="Original price:{{ $cart->products->price * $cart->qty }}">${{ $cart->products->price * $cart->qty }}.00</span>
                                                        </td>
                                                    </tr>
                                                @empty
                                            ...
                                            <tfoot>
                                                ...
                                                <tr class="cart-subtotal">
                                                    ...
                                                    <td><span class="woocommerce-Price-amount amount"
                                                            data-price="{{ $subtotal }}"
                                                            title="Original price:{{ $subtotal }}">${{ $subtotal }}.00</span>
                                                    </td>
                                                </tr>
                                            ...
                                            <ul class="wc_payment_methods payment_methods methods">
                                                <li class="wc_payment_method payment_method_bacs">
                                                    <input id="payment_method_bacs" type="radio"
                                                        class="input-radio" wire:model="payment_method"
